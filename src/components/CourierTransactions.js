...
const CourierTransactions = () => {
    ...
    const handleBankDetailSubmit = (e) => {
        ...
        if (bank_name && account_type && account_name && account_no) {
            ...
            let apiUrl = "http://localhost:7000/parcel_backends/save_cour_bank/";
    ...
    const handleBankDetailUpdate = (e) => {
        ...
        if (bank_name && account_type && account_name && account_no) {
            ...
            let apiUrl = `http://localhost:7000/parcel_backends/update_cour_bank/${email}`;
