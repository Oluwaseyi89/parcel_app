...
export const saveorder = (first_name, last_name, country, state, shipping_method,
    zip_code, street, phone_no, email, reg_date, logcus, cartTot, 
    totPrice, cartItems, customer_name, setProdSus, setProdErr, history) => {
    // e.preventDefault();
                                ...
                                if (res.status === "success") {
                                    ...
                                    if(orderId) {
                                        ...
                                        cartItems.forEach((prod) => {
                                            ...
                                            let orderItemUrl = `http://localhost:7000/parcel_order/order_item_save/${orderId}/${product_id}/`;
                                ...
                                if (res.status === "success") {
                                    ...
                                    if(anaOrdId) {
                                        ...
                                        cartItems.forEach((prod) => {
                                            ...
                                            let orderItemUrl = `http://localhost:7000/parcel_order/order_item_save/${anaOrdId}/${product_id}/`;
                                            let saveOrderItem = UseFetchJSON(orderItemUrl, 'PATCH', order_item);
                                            saveOrderItem.then((res) => {
                                                if (res.status === "success") {
                                                    setProdSus(res.data);
